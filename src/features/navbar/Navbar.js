                  ...
                  <div className="hidden md:block">
                    <div className="ml-4 flex items-center md:ml-6">
                      ...
                      {userInfo ? (
                        ...
                        <Link
                          to="/login"
                          className="ml-5 text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium"
                        >
                          Login
                        </Link>
                      )}
                ...
                {userInfo ? (
                  ...
                  <div className="border-t border-gray-700 pb-3 pt-4">
                    <div className="flex items-center px-5">
                      ...
                      <Link
                        to="/login"
                        className="ml-5 text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-base font-medium"
                      >
                        Login
                      </Link>
                    </div>
